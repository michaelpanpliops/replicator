...
public:
	explicit SingleProducerSingleConsumerRingBuffer(std::size_t capacity)
	...
	SingleProducerSingleConsumerRingBuffer(SingleProducerSingleConsumerRingBuffer&& other)
	...
	SingleProducerSingleConsumerRingBuffer(SingleProducerSingleConsumerRingBuffer const&) = delete;

	// Note: The queue should not be accessed concurrently while it's
	// being deleted. It's up to the user to synchronize this.
	~SingleProducerSingleConsumerRingBuffer()
	{
	...
	SingleProducerSingleConsumerRingBuffer& operator=(SingleProducerSingleConsumerRingBuffer&& other) noexcept
	{
		swap(other);
		return *this;
	}

	SingleProducerSingleConsumerRingBuffer& operator=(SingleProducerSingleConsumerRingBuffer const&) = delete;

	// Swaps the contents of this buffer with the contents of another.
	// Not thread-safe.
	void swap(SingleProducerSingleConsumerRingBuffer& other) noexcept
	{
